...
<div className="mil-filter mil-up mil-mb-90">
            <div className="mil-filter-links">
                <Link href="/projects" className="mil-current">All</Link>
                <Link  href='/'>Social Media Marketing</Link>
                <Link  href='/'>Paid Ads</Link>
                <Link  href='/WebDevelopment' >Web Development</Link>
                <Link  href='/Brand' className="mil-current">Branding</Link>
                <Link  href='/WebDevelopment'>PHOTOGRAPHY & VIDEOGRAPHY</Link>
            </div>
        </div>
